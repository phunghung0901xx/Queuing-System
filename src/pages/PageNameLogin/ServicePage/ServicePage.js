...
<span className={cx('select-timer')}>Chọn thời gian</span>
<input type="date"  name="date"  value="10/10/2021"/>
<svg className={cx('logo-next-two')} xmlns="http://www.w3.org/2000/svg" width="6" height="10" viewBox="0 0 6 10" fill="none">
<path d="M5.35841 4.40874L1.82507 0.875405C1.74761 0.797298 1.65544 0.735302 1.55389 0.692995C1.45234 0.650688 1.34342 0.628906 1.23341 0.628906C1.1234 0.628906 1.01448 0.650688 0.912927 0.692995C0.811378 0.735302 0.71921 0.797298 0.641741 0.875405C0.486532 1.03154 0.399414 1.24275 0.399414 1.4629C0.399414 1.68306 0.486532 1.89427 0.641741 2.0504L3.59174 5.0004L0.641741 7.9504C0.486532 8.10654 0.399414 8.31775 0.399414 8.5379C0.399414 8.75806 0.486532 8.96927 0.641741 9.1254C0.719608 9.20264 0.811955 9.26374 0.913486 9.30521C1.01502 9.34668 1.12374 9.3677 1.23341 9.36707C1.34308 9.3677 1.4518 9.34668 1.55333 9.30521C1.65486 9.26374 1.74721 9.20264 1.82507 9.1254L5.35841 5.59207C5.43652 5.5146 5.49851 5.42243 5.54082 5.32088C5.58312 5.21934 5.60491 5.11041 5.60491 5.0004C5.60491 4.89039 5.58312 4.78147 5.54082 4.67992C5.49851 4.57837 5.43652 4.48621 5.35841 4.40874Z" fill="#7E7D88"/>
</svg>
<span className={cx('add-device')}>Thêm thiết bị</span>
...
<path d="M17.5 17.5L13.875 13.875" stroke="#FF7506" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <div className={cx('column-block-one')}>
              ...
              <div className={cx('margin')}>
               ...
               <span className={cx('service-column-one')}>
               Tên dịch vụ
               </span>
               <span className={cx('service-column-two')}>
              Kiosk
               </span>
               <span className={cx('service-column-three')}>
              Kiosk
               </span>
               <span className={cx('service-column-four')}>
              Kiosk
               </span>
               <span className={cx('service-column-five')}>
              Kiosk
               </span>
               <span className={cx('service-column-six')}>
              Kiosk
               </span>
               <span className={cx('service-column-seven')}>
              Kiosk
               </span>
               <span className={cx('service-column-eight')}>
              Kiosk
               </span>
               <span className={cx('service-column-nine')}>
              Kiosk
               </span>
               <span className={cx('service-column-ten')}>
              Kiosk
               </span>
              </div>
             ...
             <div className={cx('column-block-three')}>
               <span className={cx('service-column-one-block')}>
               Mô tả
               </span>
               <span className={cx('service-column-two-block')}>
               Mô tả dịch vụ 1
               </span>
               <span className={cx('service-column-three-block')}>
               Hoạt động 
               </span>
               <span className={cx('service-column-four-block')}>
               Hoạt động 
               </span>
               <span className={cx('service-column-five-block')}>
               Hoạt động 
               </span>
               <span className={cx('service-column-six-block')}>
               Hoạt động 
               </span>
               <span className={cx('service-column-seven-block')}>
               Hoạt động 
               </span>
               <span className={cx('service-column-eight-block')}>
               Hoạt động 
               </span>
               <span className={cx('service-column-nine-block')}>
               Hoạt động 
               </span>
               <span className={cx('service-column-ten-block')}>
               Hoạt động 
               </span>
              </div>
...
<circle cx="4" cy="4.5" r="4" fill="#34CD26"/>
            ...
            <Link to="/Service/UpdateService">Chi tiết</Link>
             </span>
...
<path d="M1 11L7 6L1 1L1 11Z" stroke="#7E7D88" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
           ...
           <Link to ="/Service/AddPage" className={cx('rightbar-add')}>
